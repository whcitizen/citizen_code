...
/* 関数のプロトタイプの宣言 */
void readdata(int data[SETSIZE][CNO], int teacher[SETSIZE]);                  /* 学習データセットの読み込み */
int rand012();                                                                /* 0,1または2を返す乱数関数 */
int calcscore(int data[SETSIZE][CNO], int teacher[SETSIZE], int answer[CNO]); /* 解候補パターンのスコア(0～SETSIZE点)の計算 */
